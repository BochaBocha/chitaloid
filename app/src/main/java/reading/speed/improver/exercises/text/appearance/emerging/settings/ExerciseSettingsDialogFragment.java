package reading.speed.improver.exercises.text.appearance.emerging.settings;
...
import reading.speed.improver.exercises.text.appearance.emerging.settings.model.SettingsModel;
...
public class ExerciseSettingsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.emerging_text_exercise_settings, null);

        builder.setView(view);
        autoScrollCheckBox = view.findViewById(R.id.autoScroll_checkBox);
    ...
    private void initSpeedSeekBar() {
        ...
        speedSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                speedSelectedTextView.setText("Скорость: " + String.valueOf(((seekBar.getProgress()) * 10) + 60) + " слов в минуту");
            }
        });
