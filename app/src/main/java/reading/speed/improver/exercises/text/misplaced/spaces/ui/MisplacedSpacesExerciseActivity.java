package reading.speed.improver.exercises.text.misplaced.spaces.ui;
...
import reading.speed.improver.exercises.text.misplaced.spaces.viewModel.MisplacedSpacesExerciseViewModel;
...
public class MisplacedSpacesExerciseActivity extends AppCompatActivity implements ExerciseMenuDialogFragment.ExerciseMenuDialogListener,
        ExerciseSettingsDialogFragment.ExerciseSettingsDialogListener {
    private MisplacedSpacesExerciseViewModel exerciseViewModel;
    private View mContentView;
    private TextView currentSpeedView;
    private TextUIManager spacelessTextUIManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseViewModel = ViewModelProviders.of(this).get(MisplacedSpacesExerciseViewModel.class);
        spacelessTextUIManager = new TextUIManager(this);
        ...
        final Observer<Float> textSizeCoeffObserver = new Observer<Float>() {
            ...
            public void onChanged(@Nullable final Float textSizeCoeff) {
                spacelessTextUIManager.changeTextSizeCoeff(textSizeCoeff);
            }
        };
        ...
        final Observer<String> currentTextObserver = new Observer<String>() {
            ...
            public void onChanged(@Nullable final String text) {
                spacelessTextUIManager.setText(text);
            }
        };
